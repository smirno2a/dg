...
class LinearSystem : public ConservationLaw
{
  FieldEvaluator *A1,*A2;
 public :
  LinearSystem (FieldEvaluator *, FieldEvaluator *, FieldEvaluator *, FieldEvaluator *);
  ...
  // ith flux 
  virtual void Fi  (int ith,  const mPoint &position,double *, mVector &flux) const;
